//Declarando el controlador TopVFruitsCtrl dentro del módulo controllers (/js/controllers.js
//Este es el controller de la vista /templates/top_fruits.html
controllers.controller('TopFruitsCtrl', function ($scope, $q, $rootScope, $http, $ionicPlatform, $ionicHistory, $cordovaNativeAudio, $state, $timeout, productDataService) {
  /**
   ...
   */
    ...
    /**
      ...
      * Se llama desde la vista top fruits (/templates/top_fruits.html)
    */
   ...
   */
      restartIdleTimeCountdownTF = function(){
        $timeout.cancel(timeOutPromiseTF);
